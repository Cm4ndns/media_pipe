...
function angleAgainstWall(obj11, obj13) {
  const vector1 = [(obj11.x - obj11.x) , (obj11.y - obj11.y - 0.5)];
...
function onResultsPose(results){
  ...
  const rangeAchieved = angleAgainstWall(results.poseLandmarks[11], results.poseLandmarks[13]);
